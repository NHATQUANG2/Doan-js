          ...
          <Row>
            ...
            <Col lg='3'>
              <div>
                ...
                <div>
                  <button className="buy_btn w-100 mt-4"><Link to='/checkout'>Checkout</Link></button>
                  <button className="buy_btn w-100 mt-3"><Link to='/shop'>Containue Shopping</Link></button>
                </div>
              </div>
            </Col>
          </Row>
